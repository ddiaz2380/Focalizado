    ...
    const sideList = (
      <div className={classes.list}>
        <div className="navbar-drawer-header">
          ...
          <div className="navbar-drawer-text">Focalizado</div>
        </div>
        <Divider />
        <List>
          {/* START LINK MENU */}
           ...
           <Link to="/departamentos">
            <ListItem button key="Departamento">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="Departamento" />
            </ListItem>
          </Link>{" "}            
           <Link to="/municipios">
            <ListItem button key="Municipio">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="Municipio" />
            </ListItem>
          </Link>{" "} {/* END LINK MENU */}
        </List>
      </div>
